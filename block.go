...
// Block defines a monacoin block that provides easier and more efficient
...
// Tx returns a wrapped transaction (monautil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (monautil.Tx) for all
...
// instead provides easy access to wrapped versions (monautil.Tx) of them.
...
// NewBlock returns a new instance of a monacoin block given an underlying
...
// NewBlockFromBytes returns a new instance of a monacoin block given the
...
// NewBlockFromReader returns a new instance of a monacoin block given a
...
// NewBlockFromBlockAndBytes returns a new instance of a monacoin block given
