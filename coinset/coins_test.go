...
var (
	...
	testSimpleCoinTxValue0            = monautil.Amount(3500000)
	...
	testSimpleCoinTx, _               = monautil.NewTxFromBytes(testSimpleCoinTxBytes)
